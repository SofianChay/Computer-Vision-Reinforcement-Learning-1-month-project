...
class MultiExperiment:
    ...
    def __init__(self, target_maker_args={}, 
                       ...
                       agent_args={}, 
                       experiment_args={}, model=None, ground_truth=False, labels={}):     
        ####################################################################################################################
        self.model = model
...
####################################################################################################################
        ...
        # SOFIAN NOTE : vizdoom simulator is defined here
################################################################################################
...
#################################################################################################
        ...
        ###########################################################################################################################################################################
        self.train_experience = MultiExperienceMemory(train_experience_args, multi_simulator = self.multi_simulator, target_maker = self.target_maker, model=self.model, ground_truth=self.ground_truth, labels=self.labels)
        ###########################################################################################################################################################################
...
##########################################################################################################################################################################
        self.test_policy_experience = MultiExperienceMemory(test_policy_experience_args, multi_simulator = self.multi_simulator, target_maker = self.target_maker, model=self.model, ground_truth=self.ground_truth, labels=self.labels)
##########################################################################################################################################################################
        ...
        self.ag = FuturePredictorAgentAdvantage(self.sess, agent_args) 
