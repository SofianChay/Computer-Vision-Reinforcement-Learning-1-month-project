...
class Agent:
    ...
    def build_model(self):
        ...
        # SOFIAN COMMENT : MAYBE YOU'LL NEED TO ADD LINES FOR SEGMENTED IMAGES ...
    ...
    # HERE WE GET A BATCH WITH FUNCTION EXPERIENCE.GET_RANDOM_BATCH
    # MAYBE THIS FUNCTION WILL BE MODIFIED TO RETURN SEGMENTED IMAGES 
    # SHOULD ALSO MODIFY THE FEED_DICTIONNARY
    ...
    def train(self, simulator, experience, num_steps, test_policy_experience=None):
        ...
        # SOFIAN COMMENT : maybe here add training of UNet
