...
def main(train, ground_truth, vision):
	...
	## Simulator
	simulator_args = {}
	simulator_args['config'] = '../../maps/D4_battle2.cfg'
	...
	train_experience_args['memory_capacity'] = 2000
	...
	test_policy_experience_args['memory_capacity'] = 2500
	...
	experiment_args = {}
	experiment_args['num_train_iterations'] = 101
	...
	experiment_args['test_checkpoint'] = 'checkpoints/2017_04_08_10_46_10'
	experiment_args['test_policy_num_steps'] = 312
...
##########################################################################################################################################################################
	...
	agent_args['write_video_every'] =  100
